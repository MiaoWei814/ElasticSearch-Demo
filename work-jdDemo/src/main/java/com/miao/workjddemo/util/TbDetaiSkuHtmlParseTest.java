 ...
 **/
public class TbDetaiSkuHtmlParseTest {
    public static void main(String[] args) throws IOException {
//        String url = "http://itemcdn.tmall.com/desc/icoss613985244026ed84d9248dbe8?var=desc";
        String url = "https://mdskip.taobao.com/core/initItemDetail.htm?itemId=582816053116";
        // 动态模拟请求数据
        ...
        //获取JSON
        JSONObject jsonObject = JSONObject.parseObject(document.getElementsByTag("body").text());
        //获取sku库存信息
        JSONObject inventoryDO = jsonObject.getJSONObject("defaultModel").getJSONObject("inventoryDO");
        //总库存
        String totalQuantity = inventoryDO.getString("icTotalQuantity");
        //获取对应sku的库存
        Map skuQuantity = inventoryDO.getObject("skuQuantity", Map.class);
        //{"skuQuantity":{"4612994659587":{"quantity":162,"totalQuantity":162,"type":1},
        // "4847476822106":{"quantity":120,"totalQuantity":120,"type":1},
        // "4612994659588":{"quantity":162,"totalQuantity":162,"type":1}},
        // "totalQuantity":444,"hidden":false,"success":true,"icTotalQuantity":444,"type":1}
